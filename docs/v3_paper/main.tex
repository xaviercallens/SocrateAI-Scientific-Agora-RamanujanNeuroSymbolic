...
\title{\vspace{-1.5cm}\textbf{The Ramanujan Neuro-Symbolic Engine:\\
Exact Algebraic Surrogates, Mock Modular Forms, and Lean 4 Verification for $K3 \times T^{2}$ Dual-Scale Geometry}\\[0.4em]
\large Version 3.0 --- Includes computational certificates and live Lean 4 Tier B relaxations}
...
\input{sections/04b_bps_state_counting.tex}
